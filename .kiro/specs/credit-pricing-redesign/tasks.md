...
- [ ] 1. Database schema migration and domain models
  - [ ] 1.1 Create Alembic migration for plans table changes and new tables
  ...
  - [ ] 1.2 Update domain models and enums
...
- [ ] 2. Repository layer
  - [ ] 2.1 Create UsageTrackingRepository
  ...
  - [ ] 2.2 Update PlanRepository with get_user_active_plan method
    - Add `get_user_active_plan(user_id)` method that joins plans → licenses → users to return the user's active plan
    - _Requirements: 6.1, 6.7_

  - [ ] 2.3 Update CreditPricingRepository for ai_service rename
  ...
  - [ ] 2.4 Create SettingsRepository for system_settings
...
- [ ] 3. Checkpoint - Ensure migration and repositories work
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Service layer — Credit Pricing and Usage Enforcement
  - [ ] 4.1 Update CreditPricingService with margin computation and service availability
  ...
  - [ ] 4.4 Create UsageEnforcementService
...
- [ ] 5. Service layer — Plan validation and onboarding pricing
  - [ ] 5.1 Update PlanService with per-service limit validation
  ...
  - [ ] 5.3 Implement onboarding credit cost deduction logic
  ...
  - [ ] 5.5 Implement Global Credit Value service methods
...
- [ ] 7. Platform API router layer
  - [ ] 7.1 Update Plans router with new schemas and endpoints
  ...
  - [ ] 7.2 Update Credits router with pricing, margins, and service availability
  ...
  - [ ] 7.3 Integrate UsageEnforcementService into generation router
  ...
  - [ ] 7.4 Wire new dependencies in FastAPI DI
...
- [ ] 8. Checkpoint - Ensure all Platform API tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 9. Admin Portal — Plans page updates
  - [ ] 9.1 Update Plans page with per-service limit fields
...
- [ ] 10. Admin Portal — Credits page updates
  - [ ] 10.1 Implement Global Credit Value settings section
  ...
  - [ ] 10.2 Update credit pricing table with margins and service availability
  ...
  - [ ] 10.3 Implement client-side margin computation for instant preview
